...

{
    ...
    MakePortrait(PIPE_WIDTH, mia::windowHeight, 0, -mia::windowHeight - PIPE_HOLE_RADIUS);
    MakePortrait(PIPE_WIDTH, mia::windowHeight, 0, PIPE_HOLE_RADIUS);
...
void Pipe::Reset()
{
    ...
    int spawnBoundMax = mia::windowHeight - 20 - PIPE_HOLE_RADIUS;
